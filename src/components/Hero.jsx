    ...
    >
      <div className="flex flex-col items-center justify-center gap-10 text-white">
        ...
        <motion.div
          ...
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.8, delay: 0.2 }}
          className="flex max-w-[600] flex-col item-center justify-center gap-3 text-center"
        >
          ...
          <p className="md:text-base text-pretty text-sm text-gray-400">
            Turning ideas into seamless web experiences — Full Stack Developer
            crafting dynamic solutions with the MERN stack.
          </p>
        </motion.div>
      </div>
    </div>
