...
import { SiExpress, SiMysql, SiCplusplus, SiTailwindcss } from "react-icons/si";
...
const Tech = () => {
 ...
 w-full flex-col items-center justify-center gap-16 md:gap-32"
    >
      <motion.h1
        variants={variants}
        initial="hidden"
      ...
      <div className="flex flex-wrap items-center justify-center gap-10 p-5">
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <SiCplusplus className="cursor-pointer text-[80px] text-[#00599C] transition-all duration-300 hover:translate-y-5 sm:text-[100px] md:text-[120px]" />
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <SiTailwindcss className="cursor-pointer text-[80px] text-[#06B6D4] transition-all duration-300 hover:translate-y-5 sm:text-[100px] md:text-[120px]" />
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <SiExpress className="cursor-pointer text-[80px] text-[#EEEEEE] transition-all duration-300 hover:translate-y-5 sm:text-[100px] md:text-[120px]" />
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <SiMysql className="cursor-pointer text-[80px] text-[#4479A1] transition-all duration-300 hover:translate-y-5 sm:text-[100px] md:text-[120px]" />
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <BiLogoGithub className="cursor-pointer text-[80px] text-[#FFFFFF] transition-all duration-300 hover:translate-y-5 sm:text-[100px] md:text-[120px]" />
        </motion.div>
      </div>
    </div>
  );
